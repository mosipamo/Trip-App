...
from .views import HomeView, trip_list, TripCreateView, TripDetailView, NoteDetailView, NoteListView, NoteCreateView, NoteDeleteView, NoteUpdateView, TripDeleteView, TripUpdateView
